...
namespace HelloCloudEventStorageFunction
{
    ...
    public class Function : ICloudEventFunction<StorageObjectData>
    {
        ...
        {
            _logger.LogInformation("Storage object information:");
            _logger.LogInformation($"  Name: {data.Name}");
            _logger.LogInformation($"  Bucket: {data.Bucket}");
            _logger.LogInformation($"  Size: {data.Size}");
            _logger.LogInformation($"  Content type: {data.ContentType}");
